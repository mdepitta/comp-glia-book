...
def lr_model(pars, solver_options):
    ...
    support_code = """
                 ...
                 """
    source_files = [os.path.join(os.path.expanduser('~'), 'Ch6.DePitta.GPCR/pycustommodules/pycapi_utils.cpp'),
                    os.path.join(os.path.expanduser('~'), 'Ch6.DePitta.GPCR/pycustommodules/solvers/solver_options.cpp'),
                    os.path.join(os.path.expanduser('~'), 'Ch6.DePitta.GPCR/code/astrocyte_models.cpp')]
    code = """
           // Version
           double version = 1.0; 
           ...
           """
    libs = ['gsl', 'gslcblas', 'm']
    dirs = [os.path.join(os.path.expanduser('~'), 'Ch6.DePitta.GPCR/code/'),
            os.path.join(os.path.expanduser('~'), 'Ch6.DePitta.GPCR/pycustommodules'),
            os.path.join(os.path.expanduser('~'), 'Ch6.DePitta.GPCR/pycustommodules/solvers')]
